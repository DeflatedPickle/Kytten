...
''')
    ...
    dialog = kytten.Dialog(
        ...
        theme=kytten.themes.felyne_light, on_escape=on_escape)
...
def create_form_dialog():
    ...
    dialog = kytten.Dialog(
        ...
        window=window, batch=batch, group=fg_group,
        anchor=kytten.ANCHOR_CENTER,
        theme=kytten.themes.felyne_light, on_enter=on_enter, on_escape=on_escape)
...
def create_file_load_dialog():
    ...
    dialog = kytten.FileLoadDialog(  # by default, path is current working dir
        ...
        window=window, batch=batch, group=fg_group,
        anchor=kytten.ANCHOR_CENTER,
        theme=kytten.themes.felyne_light, on_escape=on_escape, on_select=on_select)
